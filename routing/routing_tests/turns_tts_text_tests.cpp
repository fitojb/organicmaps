...
UNIT_TEST(GetTtsTextTest)
{
  ...
  m_getTtsText.ForTestingSetLocaleWithJson(engShortJson, "en");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "In 500 meters. Make a right turn.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "In 300 meters. Make a left turn.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "You have reached the destination.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "Then. Make a left turn.", ());

  m_getTtsText.ForTestingSetLocaleWithJson(rusShortJson, "ru");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "Через 500 метров. Поворот направо.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "Через 300 метров. Поворот налево.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "Вы достигли конца маршрута.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "Затем. Поворот налево.", ());
}
...
UNIT_TEST(EndsInAcronymOrNumTest)
{
  ...
  GetTtsText getTtsText;
  m_getTtsText.ForTestingSetLocaleWithJson(huShortJson, "hu");
...
UNIT_TEST(GetTtsStreetTextTest)
{
  ...
  Notification const notification1(500, 0, false, CarDirection::TurnRight,
                                   measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Main Street"));
  Notification const notification2(300, 0, false, CarDirection::TurnLeft,
                                   measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Main Street"));
  ...
  Notification const notification5(300, 0, false, CarDirection::TurnLeft,
                                   measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Capital Parkway"));
  Notification const notification6(1000, 0, false, CarDirection::TurnRight,
                                   measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Woodhaven Boulevard","NY 25","195"));
  Notification const notification7(1000, 0, false, CarDirection::TurnRight,
                                   measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Woodhaven Boulevard","NY 25","1950"));

  m_getTtsText.ForTestingSetLocaleWithJson(engShortJson, "en");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "In 500 meters Make a right turn onto Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "In 300 meters Make a left turn onto Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "In 300 meters. Make a left turn.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "Then. Make a left turn.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification6), "Take exit 195; NY 25; Woodhaven Boulevard", ());

  m_getTtsText.ForTestingSetLocaleWithJson(jaShortJson, "ja");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "五百メートル先右折し Main Street に入ります", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "三百メートル先左折し Main Street に入ります", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "三百メートル先左折です。", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "その先左折です。", ());

  m_getTtsText.ForTestingSetLocaleWithJson(faShortJson, "fa");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "ﺩﺭ ﭖﺎﻨﺻﺩ ﻢﺗﺮﯾ ﺐﻫ ﺭﺎﺴﺗ ﺐﭙﯿﭽﯾﺩ ﺐﻫ Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "ﺩﺭ ﺲﯿﺻﺩ ﻢﺗﺮﯾ ﺐﻫ ﭻﭘ ﺐﭙﯿﭽﯾﺩ ﺐﻫ Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "ﺩﺭ ﺲﯿﺻﺩ ﻢﺗﺮﯾ ﺐﻫ ﭻﭘ ﺐﭙﯿﭽﯾﺩ.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "ﺲﭙﺳ ﺐﻫ ﭻﭘ ﺐﭙﯿﭽﯾﺩ.", ());

  m_getTtsText.ForTestingSetLocaleWithJson(arShortJson, "ar");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "ﺐﻋﺩ ﺦﻤﺴﻤﺋﺓ ﻢﺗﺭ ﺎﻨﻌﻄﻓ ﻲﻤﻴﻧﺍ ﺈﻟﻯ Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "ﺐﻋﺩ ﺙﻼﺜﻤﺋﺓ ﻢﺗﺭ ﺎﻨﻌﻄﻓ ﻲﺳﺍﺭﺍ ﺈﻟﻯ Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "ﺐﻋﺩ ﺙﻼﺜﻤﺋﺓ ﻢﺗﺭ ﺎﻨﻌﻄﻓ ﻲﺳﺍﺭﺍ.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "ﺚﻣ ﺎﻨﻌﻄﻓ ﻲﺳﺍﺭﺍ.", ());

  m_getTtsText.ForTestingSetLocaleWithJson(huShortJson, "hu");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "Ötszáz méter után Forduljon jobbra a Main Streetre", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "Háromszáz méter után Forduljon balra a Main Streetre", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "Háromszáz méter után Forduljon balra.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "Majd Forduljon balra.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification5), "Háromszáz méter után Forduljon balra a Capital Parkwayra", ()); // -ra suffix for "back" vowel endings
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification6), "Forduljon jobbra a 195; NY 25; Woodhaven Boulevardra", ()); // a for prefixing "hundred ninety five"
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification7), "Forduljon jobbra az 1950; NY 25; Woodhaven Boulevardra", ()); // az for prefixing "thousand nine hundred fifty"
  Notification const notificationHuA(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Woodhaven Boulevard","NY 25","19"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHuA), "Háromszáz méter után Forduljon jobbra a 19; NY 25; Woodhaven Boulevardra", ()); // a for prefixing "ten nine"
  Notification const notificationHuB(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Woodhaven Boulevard","NY 25","1"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHuB), "Háromszáz méter után Forduljon jobbra az 1; NY 25; Woodhaven Boulevardra", ()); // az for prefixing "one"


  Notification const notificationHu1(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("puszta"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu1), "Háromszáz méter után Forduljon jobbra a pusztára", ());
  Notification const notificationHu2(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("tanya"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu2), "Háromszáz méter után Forduljon jobbra a tanyára", ());
  Notification const notificationHu3(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("utca"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu3), "Háromszáz méter után Forduljon jobbra az utcára", ());
  Notification const notificationHu4(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("útja"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu4), "Háromszáz méter után Forduljon jobbra az útjára", ());
  Notification const notificationHu5(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("allé"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu5), "Háromszáz méter után Forduljon jobbra az allére", ()); // Some speakers say allére but it's personal judgment
  Notification const notificationHu6(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("útgyűrű"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu6), "Háromszáz méter után Forduljon jobbra az útgyűrűre", ());
  Notification const notificationHu7(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("csirke"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu7), "Háromszáz méter után Forduljon jobbra a csirkére", ());
  Notification const notificationHu8(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("10"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu8), "Háromszáz méter után Forduljon jobbra a 10re", ());
  Notification const notificationHu9(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("20"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu9), "Háromszáz méter után Forduljon jobbra a 20ra", ());
  Notification const notificationHu10(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("7"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu10), "Háromszáz méter után Forduljon jobbra a 7re", ()); // 7 is re
  Notification const notificationHu11(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("71"));
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu11), "Háromszáz méter után Forduljon jobbra a 71re", ()); // 70 is re and 1 is re
Notification const notificationHu12(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("50"));
TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu12), "Háromszáz méter után Forduljon jobbra az 50re", ()); // 5* is az and 50 is re
Notification const notificationHu13(300, 0, false, CarDirection::TurnRight, measurement_utils::Units::Metric, routing::RouteSegment::RoadNameInfo("Ybl utcá"));
TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu13), "Háromszáz méter után Forduljon jobbra az Ybl utcára", ()); // leading Y is a vowel

  m_getTtsText.ForTestingSetLocaleWithJson(nlShortJson, "nl");
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification1), "Over vijfhonderd meter naar rechts afslaan naar Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification2), "Over driehonderd meter naar links afslaan naar Main Street", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification3), "Over driehonderd meter Sla linksaf.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification4), "Daarna Sla linksaf.", ());
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notification6), "Verlaat naar 195; NY 25; Woodhaven Boulevard", ());
}
